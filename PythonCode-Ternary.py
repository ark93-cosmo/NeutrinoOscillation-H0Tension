#The following script has been used with Python3.8.10 with ipython. The first line below is to make sure that there are no errors from using Greek letters wheh running the code.
# -*- coding: utf-8 -*-
